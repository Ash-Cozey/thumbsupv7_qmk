...
[_QWERTY] = LAYOUT_ortho_5x12( \
  ...
  KC_ESC,   KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,       KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_DELETE, \
  KC_TAB,   KC_A,   KC_S,   KC_D,   KC_F,   KC_G,       KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_QUOTE,  \
  KC_BSPACE,  KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,       KC_N,   KC_M,   KC_COMMA,KC_DOT, KC_SLSH,KC_MINUS, \
    LGUI_T(KC_CAPSLOCK),KC_LALT,LSFT_T(KC_BSPACE),LCTL_T(KC_TAB),LT3(KC_SPACE),  LT3(KC_SPACE),RCTL_T(KC_DELETE),KC_SFTENT, KC_RALT,RGUI_T(KC_BSLASH)   \
),
*/
...
[_QWERTY] = LAYOUT_ortho_5x12( \
  ...
  KC_LCTL,                 KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                         KC_N,       KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RCTL, \
                 	   	    KC_LGUI, KC_LALT, KC_LSFT, CRSLEFT, KC_SPC,  KC_SPC,  CRSRGHT, KC_RSFT, KC_RALT, KC_APP                    \
),
...
[_NUMPAD] =  LAYOUT_ortho_5x12( \
  ...
  KC_LCTL,                XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    KC_COMM,     KC_1,    KC_2, KC_3, KC_DOT,      KC_RCTL, \
               KC_LGUI, KC_LALT, KC_LSFT, CRSLEFT, KC_SPC,  KC_SPC,  CRSRGHT,  KC_RSFT, KC_0, KC_DOT                      \
),
...
layer_state_t layer_state_set_user(layer_state_t state) {
    return update_tri_layer_state(state, _CRSRGHT, _CRSLEFT, _NUMBERS);
}
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (keycode) {
    ...
    case CRSRGHT:
      if (record->event.pressed) {
        layer_on(_CRSRGHT);
        update_tri_layer(_CRSRGHT, _CRSLEFT, _NUMBERS);
      } else {
        layer_off(_CRSRGHT);
        update_tri_layer(_CRSRGHT, _CRSLEFT, _NUMBERS);
       }
